...
class TestFinalMeta:
    ...
    def test___new___when_final_method_not_in_namespace_then_creates_class(self) -> None:
        # Arrange
...
class TestRuntimeFinal:
    def test_runtime_final_when_applied_to_function_then_sets_final_attribute(self) -> None:
        # Arrange
    ...
    def test_runtime_final_when_applied_to_function_then_returns_same_function(self) -> None:
        # Arrange
        def sample_function() -> str:
            return "test"
    ...
    def test_runtime_final_when_applied_to_method_then_preserves_functionality(self) -> None:
        # Arrange
    ...
    def test_runtime_final_when_applied_to_classmethod_then_sets_attributes(self) -> None:
        # Arrange
        @classmethod
    ...
    def test_runtime_final_when_applied_to_staticmethod_then_sets_attributes(self) -> None:
        # Arrange
        @staticmethod
